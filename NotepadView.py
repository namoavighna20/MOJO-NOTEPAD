...
class Notepad:
    ...
    def set_icons(self):
        ...
        self.night_blue_icon = tk.PhotoImage(file="icons/light_plus.png")
    ...
    def say_something(self):
        try:
            ...
            messagebox.showerror("Non translatable text","Speech unreconizable!")
    ...
    def remove_secure_file(self):
        try:
            ...
            messagebox.showerror("Secure file Error","Error while reading file")
            print(traceback.format_exc())
